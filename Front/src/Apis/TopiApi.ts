...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    countries = {
         ...
         * @request DELETE:/countries
         */
        countriesDelete: (params: RequestParams = {}) =>
    ...
    country = {
         ...
         */
        countryCreate: (query: { current: string }, params: RequestParams = {}) =>
    ...
    restart = {
         ...
         * @request GET:/restart
         */
        restartList: (params: RequestParams = {}) =>
            this.request<void, void>({
                path: `/restart`,
                method: 'GET',
                ...params,
